...
abstract class Data_Access {
	...
	protected function dbConnect() {
		...
		define("CONST_DB_HOST", "hostbd");  // update with the location of your MySQL host.
		define("CONST_DB_USERNAME", "userbd");
		define("CONST_DB_PASSWORD", "senhabd");
		define("CONST_DB_SCHEMA", "bd");
